...
export interface ApiCameraCamera extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ip: Attribute.Integer & Attribute.Required & Attribute.Unique;
    state: Attribute.Enumeration<['active', 'inactive', 'maintenance']>;
    installation_date: Attribute.Date & Attribute.Required;
    last_review: Attribute.Date;
    tipe: Attribute.Enumeration<['fixed', 'mobile', 'paniramic']> &
      Attribute.Required &
      Attribute.DefaultTo<'fixed'>;
    observation: Attribute.Text;
    train_station: Attribute.Relation<
      'api::camera.camera',
      'manyToOne',
...
export interface ApiTrainStationTrainStation extends Schema.CollectionType {
  ...
  attributes: {
    station_name: Attribute.String & Attribute.Required & Attribute.Unique;
    parts: Attribute.Boolean;
